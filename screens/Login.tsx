...
const Login: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (username === 'valeria' && password === 'Andrea79*') {
      setError('');
      navigate('/home');
    } else {
        ...
        <div className="glass-card-dark rounded-3xl p-8 border border-white/10 shadow-2xl">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <span className="material-icons-round text-slate-500 group-focus-within:text-purple-400 transition-colors">person</span>
                </div>
                <input 
                  type="text" 
                  value={username}
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end">
                <a href="#" className="text-xs text-slate-400 hover:text-purple-400 transition-colors">¿Olvidaste tu contraseña?</a>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            <p className="text-sm text-slate-400">
              ...
              <a href="#" className="font-bold text-purple-400 hover:text-pink-400 transition-colors ml-1">Regístrate</a>
            </p>
          </div>
        </div>
      </div>
